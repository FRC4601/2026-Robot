...
public final class Constants {
  ...
  public static class ArmConstants {
    ...
    public static final double kp = .03; // PID Values for the arm position controller. 
    public static final double ks = 0;
    public static final double kg = .0;
    public static final double kv = 0;
    public static final double ka = 0;

    public static final double ARM_EXTENDED_POSITION = 144;
    public static final double ARM_RETRACTED_POSITION = 5; // in motor rotations. needs to be set through testing
